result={
    ...
    "layers":
    {
        "ДПТ АРЕЯ" : #layer.name()
        {
            "layer_id": 'dpt_area_5df1f118_4aa9_4224_9efc_d786470dab9e', #layer.id()
            ...
            "features":
            {
                1: #створювати словник навіть якщо нема помилок
                {
                    ...
                    [
                        [1, "dpt_area_5df1f118_4aa9_4224_9efc_d786470dab9e"],
                        [1, "str_grounds_69c06b38_43bb_4854_92f3_a12f5b50c86b"],
                        [2, "str_grounds_69c06b38_43bb_4854_92f3_a12f5b50c86b"],
                        [3, "str_grounds_69c06b38_43bb_4854_92f3_a12f5b50c86b"]
                    ...
                    "topology_errors" : #Треба буде рішити як то перевіряти, поки в сам клас додавам для галочки
                    {
                        ...
                        {
                            "layer_out": "ID шару відносно якого перевірялося правило", #якщо ні, вважається що конфлікт всередині шару
                            "object_out" : "ID об'єкту з яким конфліктує" #якщо ні вважається шо з самим собою
                        }
                    }
                }
