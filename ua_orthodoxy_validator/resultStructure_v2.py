...
меню правої клавіші(кожен наступний включає пункти вищого рівня):
    ...
    'type': 'container', 'file', 'layer', 'object', 'inspection' *
    'item_name': -назва рядку у вікні- *
    'item_tooltip': -підказка-
    'related_file_path' : "-повний_шлях_до_файлу-"
    'related_layer_id' : "-ідентифікатор шару-"
    'related_object_id' : "-ідентифікатор об'єкту-" (тільк для елементів шо мають related_layer_id)
...
перевірка: "Помилка формату завантаженого обмінного файлу"
    для типу inspection:
    'error_category' : 'general', 'file', 'layer', 'object', *
    'error_type_name' : "Помилка формату завантаженого обмінного файлу" *
    'criticity' : '0'- можна не створювати тег, означає що перевірка пройдена успішно, '1'-жовта, '2'-червона (критичність помилки, від 0 - не помилка до 2 -критична помилка)
    'item_name': -назва рядку у вікні- * (якшо оцю штуку зробити списком для помилкок, то воно виведе назву типу помилки: і окремі піделементи)
    error_geometry: {
...
result_v2 = {
    "root" : 
    {
        ...
        "-повний шлях до файлу 1-" :
        {
            ...
            'file_path' : "-повний_шлях_до_файлу-",
            'real_layer_name' : "-справжня назва шару з того шо прийшло з стартового вікна-",
            'visible_layer_name' : "-відображувана назва шару з того шо прийшло з стартового вікна-",
