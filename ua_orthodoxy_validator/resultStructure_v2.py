result_v2 = [
    {
        ...
        'subitems' : [
            {
                'type' : 'inspection',
                'inspection_type_name' : "Перевірка наявності обов’язкових шарів",
    ...
    },
    {
        ...
        'subitems' : [
            {
                'type' : 'inspection',
                'inspection_type_name' : "Перевірка формату геоданих",
                'item_name' : "Формат файлу 'GeoJson' відповідає структурі",
                'criticity' : 0
            },
            {
                'type' : 'inspection',
                'inspection_type_name' : "Перевірка на наявність даних",
    ...
    },
    {
        ...
        'subitems' : [                
            ...
            {
                'type' : 'inspection',
                'inspection_type_name' : "Перевірка кодування файлу",
            ...
            },
            {
                ...
                'subitems' : [
                    {
                        'type' : 'inspection',
                        'inspection_type_name' : "Перевірка на тип геометрії",
                    ...
                    {
                        'type' : 'inspection',
                        'inspection_type_name' : "Перевірка на систему координат шару",
                    ...
                    {
                        'type' : 'inspection',
                        'inspection_type_name' : "Перевірка на відсутність полів",
                        ...
                        'subitems' : [
                            {
                                ...
                                'subitems' : [
                                    {
                                        'type' : 'inspection',
                                        'inspection_type_name' : "Перевірка наявності атрибутів",
                            ...
                            {
                                'type' : 'inspection',
                                'inspection_type_name' : "Перевірка типу геометрії об’єкта",
                            ...
                            {
                                'type' : 'inspection',
                                'inspection_type_name' : "Перевірка на наявність об’єктів в шарі",
                            ...
                            {
                                'type' : 'inspection',
                                'inspection_type_name' : "Перевірка дублювання GUID (унікального атрибуту)",
                            ...
                            {
                                'type' : 'inspection',
                                'inspection_type_name' : "Перевірка чи значення атрибуту є в переліку доменів",
